...
//Party members
var protag = Entity(name = "protag", weapon = fisticuffs, current_health = 70, max_health = 70, attack = 25, base_attack = 25, defense = 20, magic = 20, basemagic = 20, spells = mutableMapOf(1 to accelerate, 2 to buff, 3 to heal2, 4 to fireball, 5 to icicle_storm), max_mana = 30, current_mana = 30, resistance = 15, speed = 15, level = 1, xp = 0, to_next_level = 50, credits = 0)
...
//Enemies
var skeleton = Entity(name = "Skeleton", weapon = fisticuffs, current_health = 55, max_health = 55, attack = 20, base_attack = 20, defense = 5, magic = 5, basemagic = 5, spells = mutableMapOf(1 to buff, 2 to ground_fault), max_mana = 30, current_mana = 30, resistance = 5, speed = 10, level = 1, xp = 0, to_next_level = 0, credits = 0)
var imp = Entity(name = "Imp", weapon = fisticuffs, current_health = 60, max_health = 60, attack = 10, base_attack = 10, defense = 10, magic = 30, basemagic = 30, spells = mutableMapOf(1 to heal2, 2 to fireball2), max_mana = 100, current_mana = 100, resistance = 30, speed = 15, level = 3, xp = 0, to_next_level = 0, credits = 0)
